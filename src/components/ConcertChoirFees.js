...
export default function ConcertChoirFees() {
    return (
        <div className='text-center'>
            <h4>Concert Choir only payment  schedule:</h4>
            ...
            <p>You are responsible for the rental cost of your performance outfit, dance shoes, and other associated fees even if you must be removed from the group. Fundraisers will be provided for you to help cover the cost of your performance outfit and activity fee. Final cost will need to be paid in full before you will receive your choir outfit unless you have made other arrangements. We will work with you on payments, but you must contact the directors as soon as possible to set up a plan. Communication is key!</p>
