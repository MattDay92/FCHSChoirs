      ...
      <div className="offcanvas offcanvas-top" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
        ...
        <div class="offcanvas-body d-flex justify-content-center">
          <div className='col-10'>
            ...
            <h5>August 15th – $105</h5>

            <h5>September 15th – $105 </h5>
            <p>Fee payments must be up to date in order to costumes for the Fall concert</p>

            <h5>October 15th -$105</h5>

            <h5>November 15th – $105 </h5>
            <p>$650 of total fee due for outfits for Christmas concert – Students who are not up to date with fees by Dec. 13th will be blocked out of the competition season set until fees are caught up or arrangement has been made with the CBO.</p>

            <h5>January 15th – $105</h5>

            <h5>February 15th-$105</h5>
